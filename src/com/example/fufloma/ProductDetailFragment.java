	...
	private void loadElement() {
		...
		if (!productByUser)
			txtView.setText(product.getPublicLocation() + "\n"
					+ res.getString(R.string.seller) + ":\t\t" + sellCt
					+ " V / " + buyCt + " K");
		else {
			String text = product.getPublicLocation() + "<br />" + "<em>"
					+ res.getString(R.string.userIsSeller) + "</em>";
		...
		if (!productByUser) {
			intrButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					builder.setMessage(R.string.intrAlert)
							...
							.setPositiveButton(R.string.callBut,
									new DialogInterface.OnClickListener() {
										public void onClick(
												DialogInterface dialog, int id) {
											// call
			...
			intrButton.setText(R.string.deleteBut);
			...
			intrButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					builder.setMessage(R.string.wantDelete)
							.setNegativeButton(R.string.cancelBut,
									new DialogInterface.OnClickListener() {
										public void onClick(
												DialogInterface dialog, int id) {
											dialog.cancel();
							...
							.setPositiveButton(R.string.deleteBut,
									new DialogInterface.OnClickListener() {
										@SuppressWarnings("static-access")
										public void onClick(
												DialogInterface dialog, int id) {
											dataStorage.deleteObj(itemStr,
													revID);
